...
class _TimeTableScreenState extends State<TimeTableScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        backgroundColor: const Color.fromARGB(255, 32, 189, 142),
        appBar: AppBar(
  ...
  // }
    ...
    return Column(
      children: [ 
        ...
        Text(day ,style: const TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold),),sizedBoxH10,
        ui_W('First Period', contList[0]), const SizedBox(height: 0,),
        ui_W('First Period Teacher', contList[1]), sizedBoxH20,
        ui_W('Second Period', contList[2]), const SizedBox(height: 0,),
        ui_W('Second Period Teacher', contList[3]), sizedBoxH20,
        ui_W('Third Period', contList[4]), const SizedBox(height: 0,),
        ui_W('Third Period Teacher', contList[5]), sizedBoxH20,
        ui_W('Fourth Period', contList[6]), const SizedBox(height: 0,),
        ui_W('Fourth Period Teacher', contList[7]), sizedBoxH20,
        ui_W('Fifth Period', contList[8]), const SizedBox(height: 0,),
        ui_W('Fifth Period Teacher', contList[9]), sizedBoxH20, 
        ui_W('Sixth Period', contList[10]), const SizedBox(height: 0,),
        ui_W('Sixth Period Teacher', contList[11]), sizedBoxH20,
        ui_W('Seventh Period', contList[12]), const SizedBox(height: 0,),
