                      ...
                      children: [
                        ...
                        GoogleMonstserratWidgets(
                          text: Get.find<GetFireBaseData>().bYear.value +
                              ' -Manage Teacher', ////changed normal text to original batch year
                          //'2023 -2024 batch',
                          fontsize: 17.w,
                          color: cWhite,
                        )
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: GoogleMonstserratWidgets(
                                                  ...
                                                  fontsize: 15.w,
                                                  color: cBlack,fontWeight: FontWeight.bold),
                                              ),
                                            ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                GoogleMonstserratWidgets(
                          text: Get.find<GetFireBaseData>().bYear.value +
                              ' -Teacher List', ////changed normal text to original batch year
                          //'2023 -2024 batch',
                          fontsize: 17.w,
                          color: cBlack,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        GoogleMonstserratWidgets(text: data.teacherName!,
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                                    ...
                                                    height: 32.w,
                                            child: Center(child: 
                                            GoogleMonstserratWidgets(text: 'Add to teacher',
                                             fontsize: 10.w,color: cBlack,))
                                           ),
                                        ),
                                      ],
                                    ),
