...
class _CreateFoodMenuState extends State<CreateFoodMenu> {
                    ...
                    children: [
                      ...
                      FoodButton(
                        onTap: () async {
                          ...
                          bool? result2 = formKey2.currentState?.validate();
                          if (result2 == true) {
                    ...
                    children: [
                      ...
                      FoodButton(
                        onTap: () async {
                          ...
                          bool? result3 = formKey3.currentState?.validate();
                          if (result3 == true) {
                            addFoodandBeveragesToCollection(
                                'Wednesday', modell);
                          }
                            clearWedFields();
                        },
                    ...
                    children: [
                      ...
                      FoodButton(
                        onTap: () async {
                          ...
                          bool? result4 = formKey4.currentState?.validate();
                          if (result4 == true) {
                    ...
                    children: [
                      ...
                      FoodButton(
                        onTap: () async {
                          ...
                          bool? result5 = formKey5.currentState?.validate();
                          if (result5 == true) {
                    ...
                    children: [
                      ...
                      FoodButton(
                        onTap: () async {
                          ...
                          bool? result6 = formKey6.currentState?.validate();
                          if (result6 == true) {
 ...
 void clearSatFields() {
    saturdayBreak.clear();
    saturdayLunch.clear();
    saturdaySnacks.clear();
 }
  }


class FoodButton extends StatelessWidget {
  FoodButton({super.key, required this.onTap});
  VoidCallback onTap;
