...
class _FoodTimeTableMenuState extends State<FoodTimeTableMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('FOOD TIME TABLE'),
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 120, 119, 121),
...
class ItemWidget extends StatelessWidget {
  ItemWidget(
      ...
      required this.time,
      required this.day,
      required this.otherTime1,
      required this.otherTime2});
                              ...
                              onPressed: () async {
                                await FirebaseFirestore.instance
                                  ...
                                  'item1': {
                                    ...
                                    otherTime1: snap.data!.data()!['item1']
                                        [otherTime1],
                                    otherTime2: snap.data!.data()!['item1']
                                        [otherTime2],
                                  }
                                });
