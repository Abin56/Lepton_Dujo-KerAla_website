...
class ParentsViewPage extends StatelessWidget {
   ParentsViewPage({super.key, required this.classSnap});
    ...
    return Scaffold(
      body: StreamBuilder(
        ...
        .doc(schoolListValue!['docid'])
                    ...
                    .collection('classes').doc(classSnap['docid']).collection('ParentCollection').snapshots(),
                  ...
                  child: Center(
                    child: ListTile(
                      leading: CircleAvatar(
                        backgroundImage: NetworkImage(snap.data!.docs[index]['profileImageURL']),
                      ),
                      title: Text(
