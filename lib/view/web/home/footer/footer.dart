                            ...
                            Row(
                              children: [
                                Icon(Icons.location_on,
                                    color: const Color.fromARGB(255, 4, 124, 4),
                                    size: screenSize.width / 50),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(
                                        'Lepton Plus Communications(OPC) Pvt.Ltd.5th Floor',
                                        style: TextStyle(
                                            fontSize: screenSize.width / 110,
                                            fontWeight: FontWeight.bold)),
                                    Text(
                                        'Karimpanal Statue Avenue,G.H. Road, Statue',
                                        style: TextStyle(
                                            fontSize: screenSize.width / 110,
                                            fontWeight: FontWeight.bold)),
                                    Text(
                            ...
                            Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                        'Lepton plus communications(opc) pvt. Ltd Dotspace Business center,',
                                        style: TextStyle(
                                            fontSize: screenSize.width / 110,
                                            fontWeight: FontWeight.bold)),
                                    Text(
                                        'TC 24/3088,Ushasandya Building,Kowdiar - Devasom Board Road,',
                                        style: TextStyle(
                                            fontSize: screenSize.width / 110,
                                            fontWeight: FontWeight.bold)),
                                    Text(
