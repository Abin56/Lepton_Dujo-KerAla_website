...
class DujoHomePage extends StatefulWidget {
   ...
   DujoHomePage({Key? key}) : super(key: key);
                 ...
                 Stack(
                  children: [
                        ...
                        Container(
                          ...
                          Color.fromARGB(207, 39, 115, 245),  Color.fromARGB(255, 0, 7, 100),
                           ]) ),
        ...
        child: Stack(children: [
          Opacity(
              ...
              child: ClipPath(
                ...
                child: Container(
                  decoration: const BoxDecoration(gradient:LinearGradient(colors:[
                    Color.fromARGB(255, 139, 233, 201),Color.fromARGB(255, 1, 221, 184)
                  ]) ),
            ...
            //         ),
                //  ),
                  ...
                  Container(
                            ...
                            margin: EdgeInsets.only(
                                left: screenSize.width / 5.4, top: screenSize.width*1/26),
              ...
              Container(
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: ((context) => const SchoolAidedSubscription())));
                        },
                      ...
                      InkWell(
                         onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: ((context) => const CollegeAidedSubscription())));
                        },
                ...
                Row(
                 ...
                 Padding(
                  padding: EdgeInsets.only(left: screenSize.width/40, right: screenSize.width/40),
                  child: Container(
                    child: Row(
                      children: [
                        InkWell(
                            ...
                            child: Column(
                              children: [
                                ...
                                'https://cdn-icons-png.flaticon.com/512/167/167707.png'))    
                                 ...
                                 Text(
                                  "Aided Schools",
                                  style: TextStyle(fontWeight: FontWeight.bold,fontSize: screenSize.width/98),
                                ),
                              ],
                            ),
                            decoration: BoxDecoration(
                              ...
                              children: [
                                Padding(
                                 ...
                                 Text("Un Aided Schools",
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold,fontSize: screenSize.width/98)),
                              ],
                            ),
                            decoration: BoxDecoration(
                              color: Colors.white,
...
const containerColor = [
  ...
  [Color(0xFF26A69A),  Color.fromARGB(255, 148, 223, 216),],
   [Color.fromARGB(255, 15, 87, 243),  Color.fromARGB(255, 100, 46, 228),]
];