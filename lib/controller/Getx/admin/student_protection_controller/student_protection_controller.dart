      ...
      try {
        ...
        if (imageDataUin8.value != null) {
          ...
          final filePath = await firebaseStorage
              .ref(
                  'files/${Get.find<AdminLoginScreenController>().schoolID}/${Get.find<GetFireBaseData>().bYear.value}/studentProtection/$id')
    ...
    if (nameController.text.isNotEmpty &&
      ...
      try {
        ...
        if (imageDataUin8.value != null) {
          final filePath = await firebaseStorage
              .ref(
                  'files/${Get.find<AdminLoginScreenController>().schoolID}/${Get.find<GetFireBaseData>().bYear.value}/studentProtection/$imageId')
              .putData(imageDataUin8.value!);
