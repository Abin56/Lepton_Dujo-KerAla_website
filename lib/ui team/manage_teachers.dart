import 'package:dujo_kerala_website/ui%20team/manage_teacher_create.dart';
...
class _ManageTeachersState extends State<ManageTeachers> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            title: Text("MANAGE TEACHERS TO ADD SUBJECTS"),
            leading: IconButton(
              onPressed: () {
                ...
                children: [
                  Container(
                    ...
                    child: Profile(
                      ...
                      name: "Shamim Miah",
                      teacherID: "123456789", designation: '', email: '',
                    ...
                    child: TextButton(
                      ...
                      onPressed: () async {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AddTeachersSubjects(),
                            ));
                      },
                    ),
                  ),
                ...
                children: [
                  Container(
                    ...
                    child: Profile(
                      ...
                      imageUrl:
                          "https://images.unsplash.com/photo-1598618356794-eb1720430eb4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80",
                      name: "Shamim Miah", email: '', phone_number: '',
                      website: '', teacherID: "123456789",
